...
class RobertaModel(FairseqLanguageModel):
    ...
    def forward(self, src_tokens, features_only=False, return_all_hiddens=False, tagging_head_name=None, **kwargs):
    ...
    def register_tagging_head(self, name, num_classes=None, inner_dim=None, **kwargs):
        ...
        self.tagging_heads[name] = RobertaTaggingHead(
...
class RobertaTaggingHead(nn.Module):
    """Head for sentence-level tagging tasks."""
